...
<div class="gwa-popup-tab-contents">
    ...
    <table class="gwa-table" data-parent-id="type" data-parent-value="html"<?php echo empty( $postdata['type'] ) || ( !empty( $postdata['type'] ) && $postdata['type'] != 'html' ) ? ' style="display:none;"' : ''; ?>>
        ...
        <tr>
	        <th><label><?php _e( 'Horizontal Alignment', 'go_pricing_textdomain' ); ?></label></th>
            <td>
                <select name="html[valign]">
                    <option value="middle"<?php echo !empty ( $postdata['html']['valign'] ) && $postdata['html']['valign'] == 'middle' ? ' selected="selected"' : ''; ?>><?php _e( 'Middle', 'go_pricing_textdomain' ); ?></option>
                    <option value="top"<?php echo !empty ( $postdata['html']['valign'] ) && $postdata['html']['valign'] == 'top' ? ' selected="selected"' : ''; ?>><?php _e( 'Top', 'go_pricing_textdomain' ); ?></option>
                    <option value="bottom"<?php echo !empty ( $postdata['html']['valign'] ) && $postdata['html']['valign'] == 'bottom' ? ' selected="selected"' : ''; ?>><?php _e( 'Bottom', 'go_pricing_textdomain' ); ?></option>                    
                </select>            
            </td>
            <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Horizontal alignment of the content.', 'go_pricing_textdomain' ); ?></p></td>
        </tr>        
    </table>
    <!-- / HTML Content -->
    </div>
