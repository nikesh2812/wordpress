					...
					<div class="gwa-abox-content gwa-abox-tab-content">
						<table class="gwa-table">							
							...
							<tr>
								...
								<td><input type="text" name="col-width[min]" value="<?php echo esc_attr( isset( $table_data['col-width']['min'] ) ? (int)$table_data['col-width']['min'] : '' ); ?>" class="gwa-w110 gwa-mr10"><input type="text" name="col-width[max]" value="<?php echo esc_attr( isset( $table_data['col-width']['max'] ) ? (int)$table_data['col-width']['max'] : '' ); ?>" class="gwa-w110"></td>
