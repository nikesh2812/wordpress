...
class GW_GoPricing_Data {
	...
	public static function post_fields ( $fields, $query ) {
		if ($query->query['post_type'] != self::$cpt_slug) return $fields;
	...
	public static function get_table_posts( $post_ids = '', $orderby = 'ID', $order = 'ASC', $posts_per_page = -1, $offset = 0, $meta_key = '', $meta_value = '' ) {
		...
		add_filter( 'posts_fields', array( __CLASS__ ,'post_fields' ), 10, 2 );
