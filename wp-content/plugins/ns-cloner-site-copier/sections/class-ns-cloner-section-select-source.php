...
class NS_Cloner_Section_Select_Source extends NS_Cloner_Section {
	...
	public function render() {
		$this->open_section_box( __( 'Select Source', 'ns-cloner' ), __( 'Select Source', 'ns-cloner' ) );
		if ( ! is_multisite() ) {
			?>
			<h5><?php esc_html_e( 'The cloning source is set to the current site.', 'ns-cloner' ); ?></h5>
			...
			?>
			<h5><?php esc_html_e( 'The cloning source is set to the current site.', 'ns-cloner' ); ?></h5>
			<p><?php esc_html_e( 'You can use this plugin in Network mode  to choose from other source sites.', 'ns-cloner' ); ?></p>
			...
			?>
			<h5><?php esc_html_e( 'Select a site to clone', 'ns-cloner' ); ?></h5>
			...
			<p class="description ns-cloner-clear">
				...
				<?php esc_html_e( 'If you haven\'t already, now is a great time to set up a "template" site exactly the way you want the new clone site to start out (theme, plugins, settings, etc.).', 'ns-cloner' ); ?>
			</p>
			<?php
		}
